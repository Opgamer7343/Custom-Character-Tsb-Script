...
This documentation is for the custom character script which u can modify to make your own character




## Moves & Ultimate Moves name
• Move 1
```lua
...
• Note 
if you're going to make a moveset using this script please read readme file in this github repository.
